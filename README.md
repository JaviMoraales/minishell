...
The `tests/` directory contains manual and automated test scripts demonstrating:

- Command parsing with quotes and variables.
- Redirection and pipe combinations.
- Heredoc behavior and interrupt handling.
- Builtin commands test suite.
...
Maintain code style and function size constraints for easier review.
...
Special thanks to the 42 community for design inspiration and evaluation criteria.

---

## Contact

For questions, bug reports, or feature requests, please open an issue on the repository or contact the maintainers via GitHub.
